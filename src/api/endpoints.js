...
export const REACT_APP_API_USER_PERMISSIONS =
  baseUrl + "/api/users/role/permissions";
export const REACT_APP_API_CHANGE_PASSWORD =
  baseUrl + "/api/users/change_password";

export const REACT_APP_API_KEY_PAGES = baseUrl + "/api/keypages";
